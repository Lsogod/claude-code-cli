...
export function ModelPicker(t0) {
  ...
  const t16 = headerText ?? (getAPIProvider() === 'codex' ? "Switch between Codex models. Applies to this session and future One Claw sessions. For other model IDs, specify with --model." : "Switch between model options. Applies to this session and future One Claw sessions. For other or previous model names, specify with --model.");
  let t17;
  if ($[42] !== t16) {
